    ...
    <div class="single"> 
    	...
    	<div class="row" style="margin:5%;width:90%;height:20%;border:solid 1px grey;padding:10px;">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="CandidateName"><h3><%= rs.getString("username") %></h3></label>
						<label class="col-md-3 control-lable" for="CandidateName"><h3><%= rs.getString("workexp") %></h3></label>
